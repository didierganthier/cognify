...
import { Upload, FileText, X, Loader2, CheckCircle2, Link as LinkIcon } from 'lucide-react';
...
export default function UploadPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setProcessingStatus(inputMode === 'url' ? 'Fetching content from URL...' : 'Uploading file...');
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Upload a PDF or paste any web page URL to generate your study pack
        </p>
      </div>
        ...
        <CardContent>
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-start space-x-3">
              <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
              <span>
                <strong>Audio:</strong> Listen to your summary on the go
              </span>
            </li>
          </ul>
        </CardContent>
